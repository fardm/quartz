...
در توضیح یادداشت اتمی گفتند که هر مطلب فقط باید حاوی یک ایده باشد.
...
حقیقتا من خودم تمایلی به تیکه پاره کردن یادداشت ها ندارم. مثلا اگر قرار بود طبق این روش همین مطلب را می نوشتم باید 10 تا 15 صفحه مستقل ایجاد میکردم و همه آنها را با لینک به هم متصل می کردم.[^1] علاوه بر این اگر مشکل فقط مبهم بودن مقصد لینک است راه حل ساده تری برای حل این مشکل وجود دارد. هم در ابسیدین و هم در کوارتز میتوان مستقیما به هدینگ ها لینک داد. در [[obsidian install#۱۰. ایجاد لینک|اینجا]] آموزش استفاده از این روش را توضیح دادم. (همین لینک دقیقا شما را هدایت میکند به سرفصل «ایجاد لینک» از یادداشت «آموزش ابسیدین»)

برخی به خاطر همین ایراد مخالف یادداشت های اتمی هستند.([+](https://youtu.be/YB0Wn3a1ZWc?si=qmTvOMnCKAivhHcm)) اما من فکر میکنم با یک تفسیر دیگر یادداشت های اتمی هنوز هم میتوانند مفید باشند. مشابه فرایندی که در بحث [اتومیک دیزاین(Atomic Design)](https://atomicdesign.bradfrost.com/chapter-2/) در طراحی رابط کاربری مطرح می شود.
...
ساخت ایده های جدید: ترکیب اتم ها مولکول های جدید می سازد. من یک پوشه دارم برای ایده های جدید و گذرا. هر چیزی به ذهنم برسید می نویسم. وقتی که بین این یادداشت ها پرسه میزنم متوجه نزدیکی و قرابت بعضی موارد می شود. آن ها را با هم ترکیب میکنم و یک یادداشت مستقل جدید میسازم.



اتمیزه کردن محتوا
https://motamem.org/%D8%A7%D8%AA%D9%85%DB%8C%D8%B2%D9%87-%DA%A9%D8%B1%D8%AF%D9%86-%D9%85%D8%AD%D8%AA%D9%88%D8%A7/
...
[^1]: علاوه بر این اگر قصد انتشار مطالب را داشته باشید محتوای کوتاه برای موتورهای جتسجو بهینه نیست و ورودی مناسبی از گوگل نخواهید داشت.