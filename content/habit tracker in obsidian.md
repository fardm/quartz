...
> [!warning] تغییرات
> در آپدیت جدید پلاگین Persain Calendar (نسخه 3.0.1) عبارت معنادار `اول سال` و `آخر سال` به آن اضافه شده و دیگر نیازی نیست برای ساختن گزارش های سالانه تاریخ‌ شروع و پایان سال را به صورت دستی وارد کنید. با کلیک روی سال‌نوشت معادل تاریخ میلادی به طور اتوماتیک وارد می‌شود.
