...
tags:
  - 🌿جوانه_زدن
---
<div id="51819426667"><script type="text/JavaScript" src="https://www.aparat.com/embed/b36w7z1?data[rnddiv]=51819426667&data[responsive]=yes"></script></div>

<br/>

در این ویدئو بعد از نصب و راه‌اندازی نرم‌افزار علاوه بر آشنایی با رابط کاربری برنامه، یاد می‌گیریم چطور یک یادداشت جدید بنویسیم و از امکانات نرم‌افزار برای ویرایش و قالب‌بندی نوشته‌ها استفاده کنیم.
...
<br/><br/>
### ۳. لیست‌ها
برای ایجاد لیست دایره‌ای قبل از متن یک خط تیره `-` تایپ کنید و اسپیس بزنید.
```
- مورد یک
- مورد دو
- مورد سه
...
این قابلیت در حالت reading view فعال می شود. توضیحات بیشتر را [از اینجا](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax#Footnotes) مطالعه کنید.
