...
<br/><br/>
### ۳. لیست‌ها
برای ایجاد لیست گلوله‌ای قبل از متن یک خط تیره `-` تایپ کنید و اسپیس بزنید.
```
- مورد یک
- مورد دو
- مورد سه
...
به طور پیش فرض پیوست‌ها در فولدر اصلی والت ذخیره می شوند. می توانید از بخش تنظیمات مکان پیش‌فرض را شخصی سازی کنید.
`Settings → Files & Links → Default location for new attachments`

علاوه بر این به جای وارد کردن فایل از فضای محلی می‌توانید از فضای ابری هم برای جاسازی فایل‌ها استفاده کنید. برای جاسازی(Embed) لینک‌های خارجی از این عبارت استفاده کنید: `![ ](لینک تصویر)`
