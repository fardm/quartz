...
// استایل های سفارشی مشترک: هم گرید اسکرول
...
برای تنظیم این استایل می‌توانید از دو روش استفاده کنید:

اگر میخواهید روی همه جدول‌های موجود در یادداشت اعمال شود یک پرارپرتی با عنوان `cssclasses` به یادداشت خود اضافه کنید و کلاس دلخواه را وارد کنید. به این شکل:
```
---
...
> | c1-1    | نسبت تصویر را 1:1 تنظیم میکند                |
> | c16-1    | نسبت تصویر را 16:9 تنظیم میکند                |
> 
> ![[calsshelp.jpg|400]]
> 
