...
مدل dorna نسبت به مدل llama3 (که روی آن آموزش دیده) مقدار کمی عملکرد بهتری دارد. متن های فارسی بهتری می نویسند و از کاراکتر های غیر فارسی و چینی استفاده نمی کند. اما کیفیت پاسخ تفاوت چندانی ندارد و در بعضی موارد مدل اصلی پاسخ های مفصل‌تر و کامل‌تری می‌دهد. مدل جدید [llama3.1](https://ollama.com/library/llama3.1)  هم به مراتب بهتر و سریع‌تر از مدل dorna عمل می‌کند. فارسی را خوب می‌فهمد و خوب می‌نویسند. از کاراکترهای غیرفارسی هم به‌ندرت استفاده می‌کند. کیفیت پاسخ دهی مطلوب‌تر و قابل قبول‌تری هم دارد. از بین موارد زیر فقط در یک مورد عملکرد درنا بهتر از مدل اصلی بود؛ سوال در مورد [[#چند کتاب داستانی به زبان فارسی معرفی کن|معرفی کتاب به زبان فارسی]].

من هنوز مستندات کاملی از مدل Dorna پیدا نکردم. اینکه دقیقا روی چه چیزی آموزش دیده و در چه زمینه‌هایی می‌تواند عملکرد بهتری داشته باشد. اما تصور می‌کنم نسبت به برخی از داده‌های فارسی می‌تواند دقیق‌تر عمل کند. مثل همان معرفی کتاب یا شاید مثلا تحلیل و بررسی در زمینه‌های علمی و پژوهشی. ولی در باقی موارد مثل جواب دادن به سوالات عمومی، تولید محتوا، خلاصه‌سازی متن، تصحیح متن و مواردی از این قبیل مدل جدید llama 3.1 عملکرد بهتری دارد.
