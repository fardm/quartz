...
aliases:
  - مقایسه مدل اصلی llama3.1 با مدل dorna
date: 2024-09-12
draft: false
status: 💨 زودگذر
parent: 
...
من چندان تخصصی این دو مدل را بررسی نکردم. فقط چند سوال مشابه را از این دو تا مدل پرسیدم. پاسخ هر کدام را عینا همین جا قرار دادم تا خودتان مطالعه کنید و نتیجه را مقایسه کنید. مدل اصلی Llama به مراتب بهتر و سریع تر از مدل درنا عمل کرد. غیر از سوال در مورد کتاب که مدل درنا عملکرد بهتری داشت.
