...
مدل [llama3](https://ollama.com/library/llama3)  یک مدل زبانی بزرگ است که توسط شرکت متا توسعه داده شده است. یک مدل دیگر هم هست به اسم [dorna-llama3](https://ollama.com/partai/dorna-llama3) که توسط «مرکز تحقیقات هوش مصنوعی پارت» بر روی داده های فارسی آموزش داده شده.
...
مدل dorna نسبت به مدل llama3 مقدار کمی عملکرد بهتری دارد. متن های فارسی بهتری می نویسند و از کاراکتر های غیر فارسی و چینی استفاده نمی کند. اما کیفیت پاسخ تفاوت چندانی ندارد و در بعضی موارد مدل اصلی پاسخ های مفصل تر و کامل تری می دهد. مدل جدید [llama3.1](https://ollama.com/library/llama3.1)  هم به مراتب بهتر و سریع تر از مدل dorna عمل می‌کند. فارسی را خوب می فهمد و خوب می نویسند. از کاراکتر های غیر فارسی هم استفاده نمی کند. کیفیت پاسخ دهی مطلوب تر و قابل قبول تری هم دارد. از بین موارد زیر فقط در یک مورد عملکرد درنا بهتر از مدل اصلی بود؛ سوال در مورد [[#چند کتاب داستانی به زبان فارسی معرفی کن|معرفی کتاب به زبان فارسی]].
