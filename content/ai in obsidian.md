...
پلاگین [Text Generator](https://github.com/nhaouari/obsidian-textgenerator-plugin) تقریبا مشابه پلاگین قبلی است. چت بات ندارد و در محیط نرم افزار اجرا می شود. این پلاگین از سرویس‌های بیشتری مانند OpenAi, Google, Anthropic, Ollama پشتیبانی می کند.
...
## پلاگین BMO Chatbot
پلاگین [BMO Chatbot](https://github.com/longy2k/obsidian-bmo-chatbot) هم تقریبا مشابه دو پلاگین قبلی است. محیط چت بات دارد و علاوه بر Ollama از سرویس های مختلف مثل LM Studio, Anthropic, Google Gemini, OpenAI پشتیبانی می کند.
...
[^1]: پلاگین های ابسیدین در حال حاضر عملکرد چندان خوبی در این زمینه ندارند. اگر قصد دارید با محتوای خود چت کنید من  [[ollama#افزونه Page Assist]] را پیشنهاد می کنم. هم سرعت پردازش بالاتر است و هم پاسخ‌ها با محتوای شما هماهنگی بیشتری دارند.